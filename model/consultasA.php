    ...
    class consultasA{
        ...
        public function registarEmpleadoA($tipoDoc, $numDoc, $nombres, $apellidos, $celular, $telefono, $direccion, $email, $eps, $cajaCompensacion, $arl, $fondoPension, $genero, $rol, $estado, $passmd){
            ...
            if ($f) {
                ...
                $sql = "INSERT INTO empleados (ID_tipo_documento, Nro_documento_empleado, Nombres_empleado, Apellidos_empleado, Direccion_empleado, Correo_empleado, Celular_empleado, Telefono_fijo_empleado, ID_eps, ID_caja_compensacion, ID_arl, ID_fondo_pension, ID_genero, ID_rol, ID_estado, clave_empleado)
        ...
        // Modulo de clientes
        public function registrarCliente($nombres, $apellidos, $direccion, $email, $celular, $telefono, $rol, $estado, $passmd){
            //creamos el objeto de la clase conexion
            $modelo = new conexion();
            $conexion = $modelo->get_conexion();
        ...
        public function eliminarInventarioA($id_inventario){
            ...
            echo '<script> alert("Producto Eliminado del Inventario") </script>';
